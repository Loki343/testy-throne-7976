...
console.log(id);
  const getDetails = async () => {
    let res = await axios.get(
      `https://deployed-server-byloki.onrender.com/men/${id}`
    );
    return res.data;
  };
  console.log(data);
          ...
          >
            <VStack spacing={{ base: 4, sm: 6 }}>
              <Text
                ...
                fontWeight={"300"}
              >
                This is our <span style={{fontFamily:'cursive',color:'rgb(214,163,80)'}}>UNICORN</span> special product and it is made by popular fashion designers.We are perfect about fitting and size.
              </Text>
            </VStack>
            <Box>
              <Text
