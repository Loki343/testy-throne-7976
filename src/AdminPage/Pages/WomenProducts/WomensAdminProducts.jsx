...
import WomenProductRow from "./WomenProductRow";

const WomenAdminProducts = () => {
  ...
  const handleSubmit = () => {
    try {
      axios.post("https://deployed-server-byloki.onrender.com/women", ProductDetails);
      setProductDetails({
        name: "",
        title: "",
        price: "",
  ...
  const fetchData = () => {
    fetch("https://deployed-server-byloki.onrender.com/women")
            ...
            <Table>
              ...
              <Tbody>
                {products?.map((products, i) => (
                  <WomenProductRow key={i} {...products} />
                ))}
              </Tbody>
            </Table>
          </Box>
...
export default WomenAdminProducts;